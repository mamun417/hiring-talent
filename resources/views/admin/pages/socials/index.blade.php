                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive m-t-md">
                            <table class="table table-bordered table-hover">
                                ...
                                @foreach(@$socials as $social)
                                    <tr>
                                        ...
                                        <td class="text-left">{{ @$social->icon }}</td>
                                        <td class="text-left"><a target="_blank"
                                                                 href="{{ ucfirst(Str::limit(@$social->link, 50)) }}">{{ ucfirst(Str::limit(@$social->link, 50)) }}</a>
                                        </td>
                                        @can('social status')
                                            <td>
                                        ...
                                        @canany(['social edit', 'social delete'])
                                            <td>
                                                ...
                                                @can('social delete')
                                                    <button onclick="deleteRow({{ @$social->id }})"
                                                            href="JavaScript:void(0)"
                                                            title="Delete" class="btn btn-danger btn-sm cus_btn">
                                                        <i class="fa fa-trash"></i>
                                                    </button>

                                                    <form id="row-delete-form{{ @$social->id }}" method="POST"
                                                          class="d-none"
                            ...
                            @else
                                <div class="text-center">No social found</div>
                            @endif
                        </div>
                    </div>
                </div>
