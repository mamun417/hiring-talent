            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>All Sliders</h5>
                        @can('slider create')
                            <a href="{{ route('admin.sliders.create') }}" class="btn btn-sm btn-primary pull-right">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive m-t-md">
                            <table class="table table-bordered table-hover">
                                ...
                                @foreach(@$sliders as $slider)
                                    <tr>
                                        ...
                                        <td class="text-left">{{ ucfirst(Str::limit(@$slider->text, 100)) }}</td>
                                        @can('slider status')
                                            <td>
                            ...
                            @else
                                <div class="text-center">No Slider found</div>
                            @endif
                        </div>
                    </div>
                </div>
