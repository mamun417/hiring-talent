                                ...
                                @foreach($users as $user)
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img width="100" height="50" src="{{ isset($user) ? @$user->image->url : '' }}" alt="Image">
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <button onclick="deleteRow({{ @$user->id }})" href="JavaScript:void(0)"
                                                        title="Delete" class="btn btn-danger btn-sm cus_btn">
                                                    <i class="fa fa-trash"></i>
                                                </button>

                                                <form id="row-delete-form{{ @$user->id }}" method="POST" class="d-none"
