    ...
    <div class="col-sm-8">
        <div class="ibox-content">
            ...
            <form class="m-t" role="form" method="POST" action="{{ route('register') }}">
                ...
                <div id="packageType"
                     class="form-group {{ (old('account_type_id') == 1) || isset($selected_package) ? '' : 'hidden' }}">
                    <select class="form-control" name="package_id">
                        <option value="">Select Package</option>
                        @foreach($packages as $package)
                            <option
                                value="{{ $package->id }}" {{ (isset($selected_package) && ($selected_package == $package->slug)) ? 'selected' : '' }}>
                                {{ $package->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group {{ (old('account_type_id') == 1) || isset($selected_package) ? '' : 'hidden' }}"
                     id="paymentType">
                        ...
                        <div class="modal-body" style="padding: 20px">
                            <ul class="list-group clear-list m-b-none">
                                <li class="list-group-item">
                                    ...
                                    <a href="https://medmission.com.bd/terms-conditions" target="_blank">Terms &
                                        Conditions</a>
                                </li>
                                <li class="list-group-item">
                                    <span><i class="fa fa-check"></i> </span>
                                    <a href="https://medmission.com.bd/privacy-policy-2" target="_blank">Privacy
                                        Policy</a>
                                </li>
                                <li class="list-group-item">
                                    <span><i class="fa fa-check"></i> </span>
